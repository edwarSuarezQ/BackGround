...
class BackgroundRemover:
    ...
    def process_images(self):
        ...
        for filename in os.listdir(self.input_folder):
            if filename.endswith((".png", ".jpg", ".jpeg")):
                ...
                self._move_orioginals(input_path, process_folder)
    ...
    def _move_orioginals(self,input_p, dest_p):
        orginals_folders = os.path.join(dest_p, "originals")
